...
public class ListItem implements Comparable<ListItem> {
	...
	public class ItemIcon implements Icon {
		...
		public void paintIcon(Component comp, Graphics g, int x, int y) {
			...
			String strA = ((Integer) valA).toString();
			String strB = ((Integer) valB).toString();
			String bothStr = strA + " , " + strB;
			Rectangle2D rect = fm.getStringBounds(bothStr,g2);
			...
			// Draw the string.
			g2.setFont(f);
			g2.drawString(bothStr, x + offsetX, y + offsetY);
		}
	}
}